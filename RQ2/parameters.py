...
def get_baseline_feature_engineers() -> tuple[FeatureEngineer, StepwiseFeatureEngineer]:
    ...
    # ---- TIME Indicators ---- #
    # ------------------------- #
    feature_engineer.add(sin_24h) # 1
    ...
    feature_engineer.add(feat_boll_bands) # 1 * looky_backy
    ...
    stepwise_feature_engineer.add(['current_exposure'], get_current_exposure) # 1

    return feature_engineer, stepwise_feature_engineer

def old_baseline_feature_engineers() -> tuple[FeatureEngineer, StepwiseFeatureEngineer]:
    """
    Create and return the feature engineer and stepwise feature engineer objects.
    """
    # Create a feature engineer object
